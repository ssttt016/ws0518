...
<main id="main">
    ...
    <section id="about" class="about">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                <h3> "구현목적" -> <b>다양한</b> 방식의 API와 웹소켓을 요청하고 응답받는 <b>소스코드 생성 목적</b> </h3>
                <hr>
                <h5>(1) 웹소켓 : 업비트 가상화폐 거래소 데이터를 실시간으로 업데이트 받음. 스크립트에서 요청. <h5>
                    <h5>  (2) Get 방식 요청 API<br> ***** ex) 금융감독원 DART 공시정보 / 수출입은행 환율 API / Alpha Vantage 미국 상장주식 API  </h5>
                    <h5> (3) Post 방식 요청 API <br> ***** ex) Chat GPT API </h5>
                    <h5> (4) 데이터 소켓 형식 : JSON </h5>
                    <h5> (5) Chart 포맷 및 CSS : HiChart CDN / BootStrap CDN </h5>
